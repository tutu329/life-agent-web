...
def main():
    ...
    while True:
        ...
        print("   {'MessageId': 'Send_UNO_Command', 'Values': {'Command': '.uno:InsertText', 'Args': {'Text': {'type': 'string', 'value': '测试文本'}}}}")
        print("📖 (备选) Action_Paste 指令:")
        print("   {'MessageId': 'Action_Paste', 'Values': {'Mimetype': 'text/plain;charset=utf-8', 'Data': '测试文本'}}")
